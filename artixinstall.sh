...
apptitle="Artix Linux Install Script"
baseurl=https://raw.githubusercontent.com/Stormx920/artixinstall/master
cpl=0
skipfont="0"
fspkgs=""
...
if [ "${chroot}" = "1" ]; then
	...
	pacman -Sy --needed artix-live-base artix-live-openrc dialog
